    ...
    <div className="relative flex h-full w-full flex-col overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/80">
      ...
      <div className="flex flex-none items-end gap-2 border-t border-slate-800 bg-slate-900 p-3">
        ...
        <textarea
          ...
          className="max-h-[110px] flex-1 resize-none rounded-lg border border-slate-700 bg-slate-950/60 px-3 py-2 text-sm text-white placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus:border-cyan-500"
        />
